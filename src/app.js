...
var myData = {
	...
	locate: function(data_index) {
		...
		// console.log(myData.data[data_index].Lat,myData.data[data_index].Lon);
		map.setView([myData.data[data_index].Lat,myData.data[data_index].Lon], 6);
	},
	...
	fillColor: function(d) {
		if(d.Role=="Referee") return "orange";
		else return "skyblue"; 
	},
	...
	caption: function(d) {
		var o = "";
		o+="<b>"+d.Name+"</b><br>"; //right now just returns the field "name" of the data
		o+=d.Role+"<br>";
		o+=d.Birthplace+"<br>";
		$("#caption").html(o);
	},
...
function show_data() {
	...
	for(var i in data) {
		...
		var option = $("#filter_role").val();
		console.log(option);
		console.log(d.Role);
		if(option && d.Role != option) continue;
		circles.push(
